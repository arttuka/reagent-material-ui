...
(def signal-cellular-connected-no-internet-0-bar-two-tone (create-svg-icon (e (.-Fragment js/React) nil (e "path" #js {"d" "M22 8V2L2 22h16V8h4z", "fillOpacity" ".3"}) (e "path" #js {"d" "M20 22h2v-2h-2v2zm0-12v8h2v-8h-2z"}))
